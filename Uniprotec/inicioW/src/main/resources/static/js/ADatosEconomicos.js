...
//	 $("#btnAltaDatosEconomicos").click(function(){
//		 $('#asignaCliente').empty();
//			$('#asignaCliente').append("<option value='' selected  >Selecciona Cliente</option>");
//			for(i in clientes){
//				$('#asignaCliente').append("<option value='"+clientes[i].idCliente+"'>"+clientes[i].nombreCortoCliente+"</option>");
//			}
...
$("#btnActualizarDatosEconomicos").click(function(){
	...
	$('#asignaClienteTexto').val($("#asignaCliente option:selected").text());
...
$("#btnVendedoresComision").click(function(){
	...
	function formatoNumFactura(){
		var numFactura = $('#numFactura').val();
		$('#labelNumFactura').text(numFactura);
		
	}

	function formatoVentaReal(){
		var ventaR = $('#ventaReal').val();
		$('#labelVentaReal').text(formatter.format(ventaR));
	...
	function formatoPorcentajeVenta(){
		...
		$('#labelPorcentajeVenta').text(formatoPorcentaje(porcentajeVenta));
		
		if(porcentajeVenta*1 < 100){
	...
	function formatoPorcentajeComision(idVendedor){
		...
		if(ventaR > 0 && comisionV > 0 && comisionR > 0 && numFactura!=""){
	...
	function formatoComisionReal(idVendedor){
		...
		var comisionV = $('#porcentajeComision'+idAAA).val();
		var porcentajeVenta = $('#porcentajeVenta').val();
		if(ventaR > 0 && comisionV > 0 && porcentajeVenta > 0 && numFactura!=""){
			$('#btnActualizarDatosEconomicos').attr("disabled", false);
		}else{
			$('#btnActualizarDatosEconomicos').attr("disabled", true);
		}
