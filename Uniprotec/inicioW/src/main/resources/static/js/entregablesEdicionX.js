...
var asignacionCliente;
var asignacionInstructor;

var idInstructorAsignado;
var formARazonSocial;
var formACurso;
var formAInstructor;
var nombreFirmaInstructor
...
//	varios expedientes misma asignacion.
	...
	$("#idAsignacionEncabezado").html("Extra");
...
function validaCliente(){
	...
	for(var a in clientes){
		...
		if(idCliente*1 === cliente.idCliente*1){
			asignacionCliente = cliente;
			console.log(cliente);

			formARazonSocial = $("#formARazonSocial option:selected").text();
			console.log($("#formARazonSocial option:selected").text());
	...
	$('#formCRazonSocial').val(asignacionCliente.nombreCortoCliente);
	$('#formCSede').val(asignacionCliente.domicilioCliente);
		
}

function validaCurso(){
	var idCurso = $('#formACurso').val();
	
	for(var a in cursos){
		var curso = cursos[a];
		if(idCurso*1 === curso.idCurso*1){
			asignacionCurso = curso;
			console.log(curso);
			
			formACurso = $("#formACurso option:selected").text();
			console.log($("#formACurso option:selected").text());
...
function validaInstructor(){
	var idInstructor= $('#formAInstructor').val();
	
	for(var a in instructores){
		var instructor = instructores[a];
		if(idInstructor*1 === instructor.idInstructor*1){
			asignacionInstructor = instructor;
			console.log(instructor);
			
			idInstructorAsignado = $('#formAInstructor').val();
			console.log($('#formAInstructor').val());
			
			formAInstructor = $("#formAInstructor option:selected").text();
			console.log($("#formAInstructor option:selected").text());
			idInstructorAsignado = idInstructorAsignado*1;
			nombreFirmaInstructor = instructor.firmaInstructor;
			break;
		}
	}
