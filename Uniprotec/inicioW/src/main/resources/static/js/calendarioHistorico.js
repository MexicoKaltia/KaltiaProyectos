...
//	//console.log("id usuario sesion:"+idUsuario)
	...
	if($('#todosInstructores').prop('checked')){
		calendario(asignacionesHistorico, filtroInstructores, identificadorUsuario);
	}
...
//		//console.log(item.length);
		...
		for(i in asignacionesHistorico){
			asignacion0 = asignacionesHistorico[i]; 
			idCliente = asignacionesHistorico[i].idClienteAsignacion;
			$("#btnOperacion").empty();
			$("#edicionVentas").empty();
