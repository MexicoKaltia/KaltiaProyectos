...
public class AsignacionModelo_old implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1958831875740136587L;
	public AsignacionModelo_old() {
	...
	public AsignacionModelo_old(Long idAsignacion, String idAsignacionLogica, String fechaAsignacion,
